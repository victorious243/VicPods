...
# Configure each plan with either its Payment Link below or its STRIPE_PRICE_* fallback.
STRIPE_PAYMENT_LINK_WORKSPACE_CREATOR=https://buy.stripe.com/...
STRIPE_PAYMENT_LINK_WORKSPACE_GROWTH=https://buy.stripe.com/...
STRIPE_PAYMENT_LINK_WORKSPACE_STUDIO=https://buy.stripe.com/...
STRIPE_PAYMENT_LINK_HOSTING_STARTER=https://buy.stripe.com/...
STRIPE_PAYMENT_LINK_HOSTING_GROWTH=https://buy.stripe.com/...
STRIPE_PAYMENT_LINK_HOSTING_STUDIO=https://buy.stripe.com/...
BILLING_CURRENCY_SYMBOL=€
BILLING_INTERVAL_LABEL=/mo
BILLING_PAYMENT_GRACE_DAYS=7
BILLING_PRICE_WORKSPACE_FREE=0
BILLING_PRICE_WORKSPACE_CREATOR=19
BILLING_PRICE_WORKSPACE_GROWTH=39
BILLING_PRICE_WORKSPACE_STUDIO=89
BILLING_PRICE_HOSTING_NONE=0
BILLING_PRICE_HOSTING_STARTER=9
BILLING_PRICE_HOSTING_GROWTH=19
BILLING_PRICE_HOSTING_STUDIO=49
```
